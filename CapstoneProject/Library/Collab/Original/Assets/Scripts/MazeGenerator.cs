...
{
    private canvasScript canvasScriptRef;
   ...
   // private int _width;
    ...
    void Start()
    {
        targetObj.transform.position = new Vector3((_width - 1)*3, 2.2f, (_height) * 3);


        //canvasScriptRef = GameObject.Find("Canvas").GetComponent<canvasScript>();
        //Debug.Log(canvasScriptRef.width);

        //_width = canvasScriptRef.width;
        //_height = canvasScriptRef.height;
    ...
    {
        Cell currentCell = currentCell = cells[x, y];
